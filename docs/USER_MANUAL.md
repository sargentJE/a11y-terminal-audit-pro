# A11Y Terminal Audit Pro — User Manual

Version: 2.0.0

## Overview

A11Y Terminal Audit Pro is a production‑grade CLI for accessibility auditing. It crawls a site and runs three audit engines—Lighthouse, axe‑core, and Pa11y—then unifies findings into WCAG criteria with compliance scoring. Reports are exported in JSON/HTML/CSV/SARIF for engineers, QA, and CI/CD.
...
The tool computes a compliance level (A/AA/AAA/Non‑Conformant) and a numeric score (0‑100), based on severity and WCAG level deductions.
